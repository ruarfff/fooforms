 ...
 *                      'other': '{{person1}}, {{person2}} and {} other people are viewing.'}">
     ...
     * in AngularJS which sets the display styles to none (using an !important flag).
     *
     * <pre>
 ...
 * }
     ...
     * @example
     ...
     ng-styles="{'background-color':color.name}">
     </div>
     </div>
     </doc:source>
     <doc:scenario>
...
angular.element(document).find('head').prepend('<styles type="text/css">@charset "UTF-8";[ng\\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide{display:none !important;}ng\\:form{display:block;}</styles>');