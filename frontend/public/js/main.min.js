...
fooformsApp.config(function ($routeProvider, $locationProvider) {
    ...
    updateAppList(), $scope.hover = function (app) {
        ...
        app.remove().then(function () {
            ...
            index > -1 && $scope.apps.splice(index, 1)
        }, function (err) {
            console.log(err.status), $("#thumb-" + app._id).effect("shake")
        })
    }
    ...
    }), $scope.app = {name: "Untitled App", icon: "/assets/icons/color/document.png", description: "My new app - it's totally awesome!", menuLabel: "Untitled App", btnLabel: "New Post", settings: {allowComments: !0, status: "draft", displayOptions: [
