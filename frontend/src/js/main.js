var fooformsApp = angular.module('fooformsApp', [
    'ngRoute', 'restangular', 'ui.bootstrap', 'textAngular', 'ui.calendar', 'ngGrid','angularFileUpload'
]);
...
fooformsApp.controller('MainController', function ($scope, $location, USER_ROLES, AuthService, $upload) {
    $scope.user = null;
    ...
    $scope.onFileSelect = function($files,appField) {
        ...
        for (var i = 0; i < $files.length; i++) {
            ...
            $scope.upload = $upload.upload({
                ...
                data: {fieldObj: appField, file: file }
